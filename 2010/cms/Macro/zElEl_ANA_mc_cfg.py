...
process.source = cms.Source("PoolSource",
    ...
    #'rfio:/castor/cern.ch/user/b/bianchi/CMSSW361p2/patLayer/Run2010APromptReco/analysis_DiTau_VBF_PF2PAT_1_1_4Nh.root',
    #'rfio:/castor/cern.ch/user/b/bianchi/CMSSW370p2/patLayer/Zee/analysis_DiEle_PF2PAT_10_1_Rih.root'
"/afs/cern.ch/user/a/abis/scratch0/ntuple/RelValZEE_CMSSW_3_7_0-START37_V4-v1_fastsim.root"
    )
...
process.ZeeEDFilterAnalyzer = cms.EDFilter("ZeeEDFilterAnalyzer",
                                           cfgFileName = cms.untracked.string("zElEl_ANA_mc_cfg.py")
                                           )
