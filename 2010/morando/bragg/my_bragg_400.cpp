...
int main(int argc, char **argv) {
    ...
    //analyze data at 400mbar
    //read arguments from command line:
    //my_bragg file_name n_events first_background_bin
    //+ mean bragg maximum of events stopped inside the ionization chamber
    stringstream args;
    ...
    for (int i = 0; i < n_events; i++){
        ...
        //escaped event
        if (integr > 5000 and bragg_max < 149) limit = mean_maximum * 0.45 + backg;
