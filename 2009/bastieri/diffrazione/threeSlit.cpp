#ifndef THREESLITCLASS
#define THREESLITCLASS
...
ThreeSlit::ThreeSlit( Int_t found, Float_t* peaks, Double_t ms ) : Slit( found, peaks ){
	maxstep = ms;
	j = 0;
...
TGraphErrors* ThreeSlit::drawAndFit(){
...
Double_t* ThreeSlit::getSlitWidth(){
